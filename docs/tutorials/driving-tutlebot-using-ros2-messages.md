...
Property 탭에서 useDomainIDEnvVar를 체크하세요.
...
트위스트 메시지를 구독합니다.
Property 탭에서 topicName에 /cmd_vel을 입력하세요.
...
Property 탭에서 다음 표를 참고해서 maxAngularSpeed, maxLinearSpeed, wheelDistance, wheelRadius를 입력하세요.
| Field | Value |
|-|-|
...
turtlebot3_burger 하위의 base_footprint에 Articulation Root API가 있을 경우
