...
> <img width="500" alt="image" src="https://github.com/user-attachments/assets/dbfff9a5-f0b7-45d8-bd31-b36216fb7a7c" /><br>
...
> > ros2 service list
> > ```
> > <img width="300" alt="image" src="https://github.com/user-attachments/assets/3d9d5929-7be5-4aa4-9dca-598d820bb5d9" /><br>
> 
> - 모든 child prim paths와 types을 prim `/World` 아래로 가져옵니다:
> > ```bash
> > ros2 service call /get_prims isaac_ros2_messages/srv/GetPrims "{path: /World}"
> > ```
> > <img width="300" alt="image" src="https://github.com/user-attachments/assets/f3f9d6ed-effb-462f-b29f-1f5f1cf6e836" /><br>
> 
...
> > ```
> > <img width="300" alt="image" src="https://github.com/user-attachments/assets/998d1d2a-9b66-4294-8103-3e303a07fe50" /><br>
> 
...
> > ```
> > <img width="300" alt="image" src="https://github.com/user-attachments/assets/27c92936-0c76-4d94-b54c-294656dcb8ca" /><br>
> > <img width="300" alt="image" src="https://github.com/user-attachments/assets/467c011a-06ff-4742-aa5a-b7fb0e949b04" /><br>
> 
...
> > ```
> > [ros2_service_for_manipulating_prims_attributes.webm](https://github.com/user-attachments/assets/8ef53365-a7bc-4a2f-93c5-b44ec01fbc7e)
